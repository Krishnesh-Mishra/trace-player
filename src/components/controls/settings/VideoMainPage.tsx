      ...
      <div className="px-1 py-1">
        ...
        >
          <span className="flex items-start gap-2">
            <Globe className="w-3.5 h-3.5 text-[var(--np-text-secondary)] mt-0.5" />
            <span className="flex flex-col items-start">
              <span>Source</span>
              <span className="text-[9px] text-[var(--np-text-tertiary)] mt-0.5">
        ...
        >
          <span className="flex items-start gap-2">
            <Palette className="w-3.5 h-3.5 text-[var(--np-text-secondary)] mt-0.5" />
            <span className="flex flex-col items-start">
        ...
        >
          <span className="flex items-start gap-2">
            <Settings2 className="w-3.5 h-3.5 text-[var(--np-text-secondary)] mt-0.5" />
            <span className="flex flex-col items-start">
              <span>Quality</span>
              <span className="text-[9px] text-[var(--np-text-tertiary)] mt-0.5">
        ...
        <div className="border-t border-[var(--np-divider)] mt-1 pt-1">
          <ToggleRow
            label="Deinterlace"
